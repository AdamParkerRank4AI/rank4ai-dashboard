...
| 8 | Company Rescue / LTD Turnaround | **4** / ~50 | 0 / 41 | **13** / 2 | 41 / 535 | launched live + lead pipeline · **B33 4 insolvency Q-pages BANKED, HELD on named Licensed IP** · IndexNow automated 29 Jun · verify privacy-404 · named-IP page · a11y labels |
...
| 12 | New IF site (2nd) | 0 / 90 | 0 / 167 | 2 / 4 | 170 / 40 | most-built, **not live** · ⚠️ **170 capsules present but EMPTY-PROP BUG** (51 /statistics/ pages pass text as an `answer=` prop the component ignores, so they render empty; being fixed separately) · port 85-provider DB · embedded-finance + halal · 5 go-live decisions = Adam |
