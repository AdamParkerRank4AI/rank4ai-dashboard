...
def run_client(client_id, config):
    ...
    domain = {"rank4ai": "rank4ai.co.uk", "market-invoice": "marketinvoice.co.uk", "seocompare": "seocompare.co.uk", "bestbusinessloans": "bestbusinessloans.ai", "fundbiz": "fundbiz.co.uk", "cardmachines": "merchanthq.co.uk", "peptideclear": "peptideclear.co.uk", "merchanthq": "merchanthq.co.uk", "kartapay": "kartapay.co.uk"}.get(client_id, "")
