...
CLIENTS = {
    ...
    "fundbiz": {
        "queries": [
            ...
            "corporation tax bridge loan",
            "CIS deduction finance UK",
            "asset refinance UK",
            "specialty business finance UK",
            "trigger event business finance",
            "emergency business funding UK",
            "tax bill loan UK",
            "business cashflow loan UK",
            "alternative SME finance UK",
            "non-standard business lender UK",
            "fundbiz reviews",
            "fundbiz vs swoop",
            "fundbiz vs funding circle",
        ],
    },
    "cardmachines": {
        "queries": [
            ...
            "card machine hospitality UK",
            "card machine retail UK",
            "online payment gateway UK",
            "dojo vs sumup vs square",
            "card terminal monthly cost UK",
            "high-risk merchant account UK",
            "card machine no contract UK",
            "acceptcard reviews",
        ],
    },
}
